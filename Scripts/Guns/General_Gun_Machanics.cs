...
public class General_Gun_Machanics : MonoBehaviour
{
    ...
    [HideInInspector]
    public float Gun_Recoil_amount;
    ...
    private Player_Movement Player_cs;
    ...
    void Start()
    {
        ...
        ui_Handler = handler_Referencer.ui_Handler;
        camera_Effect_Handler = handler_Referencer.camera_Effect_Handler;
        Player_cs = GameObject.FindGameObjectWithTag("Player").GetComponent<Player_Movement>();
        cam = Camera.main;
        Current_gun_info = Revolver_Info;
        fire_rate_temp = Current_gun_info.Fire_rate;
        ui_Handler.selected_Ability_Name.text = "Revolver";
        ...
        Guns_originalPosition = first_Person_Data.Current_selected_gun_obj.transform.localPosition;
        Guns_originalRotation = first_Person_Data.Current_selected_gun_obj.transform.localRotation;
    }
    ...
    void Update()
    {
        ...
        if (first_Person_Data.isAbilitySelected)
            return;
        Change_current_Gun();
    ...
    public void Shoot()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            if (fire_rate_temp <= 0)
            {
                ...
                Gun_Recoil_amount = Current_gun_info.Upward_Recoil_effect_amount;
                ...
                Player_cs.HasShot = true;
            }
            else
            {
                Player_cs.HasShot = false;
            }
        }
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            Player_cs.HasShot = false;//To make sure that the recoil effect is stopped 
        }
    }
    ...
    public void Change_current_Gun()
    {
        ...
        {
            G_type++;
            ui_Handler.selected_Ability_Name.text = G_type.ToString();
        ...
        {
            fire_rate_temp = 0;
            ui_Handler.Text_in(ui_Handler.selected_Ability_Name);
            //first_Person_Data.Current_selected_gun_obj.SetActive(true);
            first_Person_Data.Current_selected_gun_obj.SetActive(true);
        ...
        ui_Handler.Text_fade_out(ui_Handler.selected_Ability_Name);
    }
